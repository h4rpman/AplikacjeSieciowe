...
<form action="<?php print(_APP_ROOT); ?>/app/calc.php" method="post" class="pure-form pure-form-stacked">
	...
	<fieldset>
		<label for="id_x">Liczba 1 / Kwota kredytu: </label>
		...
		<select name="op">	
			...
			<option value="div">/</option>
                        <option value="loan">%</option> <!-- przy wyborze % oblicza rate kredytu -->
		</select>
                
		<label for="id_y">Liczba 2 / Oprocentowanie kredytu: </label>              
		<input id="id_y" type="text" name="y" value="<?php out($y) ?>" />
                
                <label for="id_z">Lata kredytu </label>
